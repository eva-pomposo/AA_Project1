...
def configurations_tested(exhaustive_search):
    vertices_num = exhaustive_search['vertices_num']
    percentage_max_num_edges = exhaustive_search['percentage_max_num_edges']
    configurations_tested = exhaustive_search['configurations_tested']
    ...
    plt.legend()
    plt.title('Number of Configurations Tested for each Experiment with Exhaustive Search')
    plt.xlabel('Vertices Number')
    plt.ylabel('Number of Configurations Tested')
    plt.savefig("graphics/configurations_tested_exhaustive_search.png")
    plt.clf()
...
def main():
    ...
    configurations_tested(exhaustive_search)
    compare_solutions(exhaustive_search, greedy)
